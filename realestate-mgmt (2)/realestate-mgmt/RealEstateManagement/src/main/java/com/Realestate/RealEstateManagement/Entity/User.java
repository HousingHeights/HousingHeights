...
public class User {
    ...
    public User(Long id, String username, String email, String password, Role role, String otp, LocalDateTime otpExpiration) {
        this.id = id;
...
// ✅ Each user can have only one role
    ...
    @Column(name = "otp")
    private String otp; // OTP for 2FA

    @Column(name = "otp_expiration")
    private LocalDateTime otpExpiration; // Expiration ti
