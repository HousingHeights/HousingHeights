...
public class UserService {
    ...
    public UserService(UserRepository userRepository, PasswordEncoder passwordEncoder, JwtUtil jwtUtil, OtpService otpService) {
...
public class UserService {
    ...
    public ResponseEntity<Map<String, String>> loginUser(String email, String password) {
        ...
        logger.info("OTP sent to user's email for 2FA verification!");
